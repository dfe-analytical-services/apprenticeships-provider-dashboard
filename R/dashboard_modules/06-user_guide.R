user_guide <- function() {
  div(
    ...
    h2("User guide"),
    p(
      "This interactive tool shows data on apprenticeship starts, enrolments and achievements by providers, for
    ...
    h3("Apprenticeships"),
    p(
      "Apprenticeships are paid jobs that incorporate on-the-job and off-the-job training leading to nationally
    ...
    p(
      "Starts are a count of the number of apprenticeships that begin within an academic year (for final data) or
    ...
    p(
      "Enrolments are a count of the total number of apprenticeship learning aims undertaken at any point during
    ...
    p(
      "Achievements are a count of successfully completed apprenticeships within an academic year (for final
