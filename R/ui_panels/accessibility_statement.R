    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          p(
            "If you need information on this website in a different format please see ",
            a(
              href = "https://explore-education-statistics.service.gov.uk/find-statistics/apprenticeships",
              "Apprenticeships on Explore education statistics",
              .noWS = "after"
            ),
          ...
          p(
            ...
            a(
              href = "https://github.com/dfe-analytical-services/apprenticeships-provider-dashboard/issues",
              "GitHub issues page",
              .noWS = "after"
            ),
            "."
