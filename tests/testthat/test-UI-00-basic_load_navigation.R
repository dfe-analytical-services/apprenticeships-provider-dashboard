...
app <- AppDriver$new(
  ...
  load_timeout = 56 * 1000, # set to 30seconds, default is 15
)
...
test_that("App loads and title of app appears as expected", {
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - provider breakdowns"
  )
})
...
test_that("Tab titles load when switching", {
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - local authority district"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - subjects and standards"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - learner characteristics"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - national provider summary"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - user guide"
  )
...
test_that("Footer link and back links work", {
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - footnotes"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - support"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - accessibility statement"
  )
  ...
  expect_equal(
    app$get_text("title"),
    "Apprenticeships provider dashboard - cookies statement"
  )
